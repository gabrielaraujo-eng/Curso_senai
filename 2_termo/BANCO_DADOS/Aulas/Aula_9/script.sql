...
FOREIGN KEY(id_delivery) REFERENCES Delivery+Pagamento (id_delivery,id_pedidos,id_pagamento)
)
...
CREATE TABLE Relação_2+item_pedido (
id_produtos int,
id_delivery int,
id_pedidos int,
id_pagamento int,
...
FOREIGN KEY(/*erro: ??*/) REFERENCES Delivery+Pedidos+Pagamento (id_delivery,id_pedidos,id_pagamento)
)
...
FOREIGN KEY(/*erro: ??*/) REFERENCES Clientes+Programa_fidelidade (id_clientes,id_fidelidade),
FOREIGN KEY(/*erro: ??*/) REFERENCES Delivery+Pedidos+Pagamento (id_delivery,id_pedidos,id_pagamento)
)

ALTER TABLE entrega ADD FOREIGN KEY(/*erro: ??*/) REFERENCES Delivery+Pedidos+Pagamento (id_delivery,id_pedidos,id_pagamento)
ALTER TABLE entrega ADD FOREIGN KEY(id_funcionario) REFERENCES Funcionario (id_funcionario)
ALTER TABLE Relação_3+ficha_tecnica ADD FOREIGN KEY(id_insumo) REFERENCES Estoque (id_insumo)
